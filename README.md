...
El catálogo v3 incluye `data_steward`, `risk_manager` y `trader`. Los dos especialistas se materializan desde templates versionados con manifiesto, SOUL, fundamento y contexto; reciben Knowledge escribible en rama y mounts read-only para dataset y Tradix. Trader añade lectura declarativa de mercado, señales y métricas. Ninguno dispone de escritura de producto, órdenes, capital, secretos, Docker, promoción, merge ni autoaprobación.
