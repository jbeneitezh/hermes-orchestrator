...
def test_openapi_contains_the_bootstrap_and_catalog_routes(monkeypatch) -> None:
    ...
    assert domain_paths == {
        ...
        "/v1/agents",
        "/v1/agents/requests",
        "/v1/agents/requests/{request_id}",
        "/v1/agents/requests/{request_id}/decide",
        "/v1/agents/requests/{request_id}/retire",
        "/v1/agents/requests/{request_id}/provision",
        "/v1/agents/requests/{request_id}/rollback",
        "/v1/agents/{agent_id}",
